...
This base itself isn't going to help you code or anything!! Nor does it provide basic Java learning - if you need that you should take a free online java course, such as one provided by Codecademy. While there are plenty of comments about what does what, this is just a nice starting point if you need a place to start learning from that's not an absolute empty canvas, or an overly-complicated, difficult to understand mod. But you still need to learn how the in-game code works and how to piece things together on your own. (i.e. this base will show you where to put the code for double-tap, but not what it is/how to write it. Look up the actual cards and reverse-engineer them for that.)
...
https://github.com/Alchyr/StS-DefaultModBase/wiki

---

## Know what you're doing?

Hop on over to the Quick Start branch. It's a fully cloneable, uncommented version of the Default ready for jump-starting a brand new mod, or use https://github.com/DarkVexon/ProTemplate which has more features but a bit less documentation.
...
(If you want to contribute to this collection feel free to send me a message through the [official Discord's #modding channel](https://discord.gg/slaythespire) or a github issue https://github.com/Gremious/StS-DefaultModBase/issues here, on the original.)
